...
焙煎後の容器は200℃以上の高温になるため、安全性の観点から**取っ手付き**の容器が適しています。  
...
### 8. 焙煎ログ用 Spreadsheet Template

当マニュアル筆者が使用している, 焙煎ログ用の spreadsheet のテンプレートファイルを以下に添付します.

[焙煎ログシート テンプレート ODS版](../docs/coffee_microvave_roasting_template_v4_ja.ods)  
[焙煎ログシート テンプレート PDF版](../docs/coffee_microvave_roasting_template_v4_ja.pdf)  

Note-1: 照射時間, インターバル時間, 体積 を各行に記録してゆきます.

Note-2: 撹拌温度, 重量を記録するカラムはありますが, 温度, 重量を計測するのは (1) 焙煎開始前の初期条件, (2) 4x 300W 60s の焙煎初期工程が終わった時, (3) 焙煎終了時の３回のみです. 焙煎中に都度, 温度・重量を測るのはインターバル時間が長くなり過ぎ, 焙煎進行を適正に管理するのが難しいからです.

Note-3: ここで提示するテンプレートはあくまでマニュアル筆者の実践例であり, 各個で自由に使いやすいよう改変してください.

### 9. キッチンタイマー

ログシートに経過時間を記録してゆくため, キッチンタイマーを使う.
スマホのタイマーアプリでも構わない.
