...
144g なのは, コーヒー豆 一袋 1kg を等分してうまく 150g 前後の重さに調整,  
とすると, 1kg / 7 = 約 143g
...
今回の Ethiopia Baturo, 30分吸水後, 144g -> 183.3g への増加であった.   
前回同じ豆の焙煎時は, 30分吸水後, 144g -> 192.0g への増加であった.   

Ethiopia のコーヒー生豆は, 高い標高で育成され, 固い豆が多く,   
中米, 南米の低,中標高 (1600m 以下) で育った Washed 精製豆よりは吸水量は少ない傾向.  

今回, 183.3g と 180g 台前半である, ということは,  
あまり給水量が多くなかった, という分類になり,  
結果として, 焙煎進行 (熱の入り具合)が早くなる可能性が高いことを予測する.  

一方この Shidama Baturo の豆は, 経験上,  
1ハゼ開始後, 豆温度を上げ渋る傾向があることが分かっていて,   
従い, 十分な熱量を加える必要があることも考慮に入れ焙煎を開始する.  

| | |
| ---- | ---- |
| 豆の初期温度 | 30.2℃ | 焙煎開始前に赤外線で計測 |
| 豆の初期体積 | 275ml |
| ガラス焙煎容器をふくめた総重量 | 452.3g |
...
| ---- | ---- | ---- | ---- | ---- | ---- | 
| 1 | 300W | 60s| 21s | 275ml | 60s 照射して, レンジから容器を取り出し容器を振って撹拌,レンジ庫内へ戻す で 21s の意 |
| 2 | 300W | 60s| 23s | 300ml- | `300ml-` は 300ml よりすこーし少ない, の意 |
...
| No. | ワット | 照射時間 | 撹拌インターバル | 体積 | Note |
| ---- | ---- | ---- | ---- | ---- | ---- | 
| 5 | 800W | 30s| 29s | 300ml | 30s 照射して, レンジから容器を取り出し容器を振って撹拌,レンジ庫内へ戻す で 29s の意 |
| 6 | 500W | 50s| 32s | 300ml | |
| 7 | 800W | 60s| 29s | 275/300ml | `275/300` は, 275ml と 300ml の間くらいの体積, の意 |
...
"500W 50s (25000 Ws)" は使わず, `600W 40s` (`24000 Ws`) を選択.

| No. | ワット | 照射時間 | 撹拌インターバル | 体積 | Note |
| ---- | ---- | ---- | ---- | ---- | ---- | 
| 9 | 600W | 40s| 23s | 275ml | |
| 10 | 600W | 40s| 27s | 250/275ml | コーヒー豆が色づきはじめる. 少し濃い色のもの, 薄いものまだらの状態になる |
| 11 | 600W | 40s| 29s | 250/275ml | |

さらに 600W 40s 照射を続ける. 色付きがだんだん濃くなってくる.

| No. | ワット | 照射時間 | 撹拌インターバル | 体積 | Note |
| ---- | ---- | ---- | ---- | ---- | ---- | 
| 12 | 600W | 40s| 26s | 250ml+ | `250ml+` は 250ml よりすこーし多い, の意味 |
| 13 | 600W | 40s| 24s | 250ml+ | コーヒー豆が一回だけ, プスンとはぜる |
| 14 | 600W | 40s| 31s | 275ml- | `275ml-` は 275ml よりすこーし少ない, の意味. 体積増加の**転換点** |
...
1ハゼが始まると焙煎進行が遅くなる (温度を上げ渋ると推測) 傾向があることがわかっている.  
熱量を補うため, step-7 へ移行する前に, もう１押し, 600W 30s を１段入れる.

| No. | ワット | 照射時間 | 撹拌インターバル | 体積 | Note |
| ---- | ---- | ---- | ---- | ---- | ---- | 
| 15 | 600W | 30s| 29s | 275ml+ | `275+ml` は 275ml よりすこーし多い, の意味 |

体積増が少しづつ進行し, もう１ハゼが始まる直前だが, しかしまだ始まらない. これは狙い通りの進行具合だ.
...
| No. | ワット | 照射時間 | 撹拌インターバル | 体積 | Note |
| ---- | ---- | ---- | ---- | ---- | ---- | 
| 16 | 800W | 20s| 28s | 275ml+ | しーん. まだ1ハゼははじまらない |
| 17 | 600W | 20s| 29s | 275ml+ | しーん. まだ1ハゼははじまらない |
...
| ---- | ---- | 
| 照射ステップ数 | 24 | 
| No.1-24 のトータル microwave 照射時間 | 13:35 |
...
| 焙煎後の豆の重量 | 119.2g | 119.2g から不良豆 1.2g を取り除いた. よって最終的なあがりは 118g |
